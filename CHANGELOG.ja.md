...
- クエリ解析を寛容モードに変更
- ngram インデックスにおける auto クエリ前処理の AND 検索を修正（全トークンをクォート・エスケープし、空白を含むトークンを除外）
...
[Unreleased]: https://github.com/kyow/traverze/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/kyow/traverze/compare/v0.2.0...v0.3.0
